...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitUserAdd" class="floatdiv_content"
		style="width:500px">
			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						...
						<div class="submitWarningChange">
							<form name="adduser"
								action="AddUserAction.action" method="post">
								...
								<table width="100%">
									...
									<tr>
										<td><label>再次输入密码：</label>
										</td>
										<td><input id="pwdag" name="pwdag" type="password" />
										</td>
									</tr>
									<tr>
										<td><label>用户组：</label>
									...
									<tr>
										...
										<td><textarea name="unote"></textarea>
										</td>
									</tr>
									<tr>
										<td align="center" colspan="2"><a class="button"
											onclick="adduser.submit()"><span
												class="buttonRight">提交</span> </a> <a class="button"
											href="javascript:visclose('submitUserAdd')"><span
