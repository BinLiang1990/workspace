...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitUserModify" class="floatdiv_content" style="width:500px">
			...
			<td class="td_centercenter"><div class="floatdiv_body">
					...
					<div class="submitAccept">
						<form name="acceptedForm" id="acceptedForm"
							...
							<input type="hidden" id="acplid"  name="acplid"/> <input type="hidden"
								id="acceptedPerson" name="acceptedPerson" />

							<table width="100%">
								<tr>
									<td align="center" colspan="2"><a class="button"
										onclick="acceptedForm.submit()"><span class="buttonRight">提交</span> </a>
										<a class="button" href="javascript:visclose('submitAccept')"><span
