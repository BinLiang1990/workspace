...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitInfoChange" class="floatdiv_content" style="width:500px">
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						...
						<div class="submitInfoChange">
							<form name="infochangeform" action="ModifySelfAction.action"
								method="post">
								<input type="hidden" name="id" id="id" value="<s:property value='loginUser.id' />" readonly />
								<table width="100%">
									<tr>
										<td><label>登录名</label></td>
										<td><input type="text" name="uid" id="uid" value="<s:property value='loginUser.userid' />" readonly /></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="text" name="ugroup" id="ugroup" value="<s:property value='loginUser.usergroup' />" readonly />
										</td>
									</tr>
									<tr>
										<td><label>用户名</label></td>
										<td><input id="uname" name="uname" type="text" value="<s:property value='loginUser.username' />"/></td>
									</tr>
									<tr>
										<td><label>电话</label></td>
										<td><input id="uphone" name="uphone" type="text" value="<s:property value='loginUser.phone' />"/></td>
									</tr>
									<tr>
										<td><label>备注</label></td>
										<td><textarea name="unote" id="unote"><s:property value='loginUser.note' /></textarea></td>
									</tr>
									<tr>
										<td align="center" colspan="2"><a class="button"
											onclick="infochangeform.submit()"><span class="buttonRight">提交</span>
										</a> <a class="button"
