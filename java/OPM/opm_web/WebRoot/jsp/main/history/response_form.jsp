			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						...
						<div class="submitResponse">
							<form name="responseaction"
								action="HistoryResponsedAction.action" method="post">
								<input type="hidden" id="reshid" name="reshid" /> <input
									type="hidden" id="lid" name="lid" />

								<table>
									<tr>
										<td width="20%">响应人：</td>
										<td width="80%"><input type="text"
											name="responsedPersonId"
