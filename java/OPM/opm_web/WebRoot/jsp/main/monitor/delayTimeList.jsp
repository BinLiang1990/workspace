...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitDelayTimeListChange" class="floatdiv_content"
		style="width: 500px">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td width="13" height="33" class="td_topleft"></td>
				<td class="td_topcenter"><div class="floatdiv_top"
						onMouseDown="moveEvent(event,'submitDelayTimeListChange')">
						<span>延迟时间调整</span>
						<!-- 弹出层标题 -->
						<a href="javascript:visclose('submitDelayTimeListChange')"> <img
			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						<!-- 弹出层内容开始 -->
						<div class="submitDelayTimeListChange">
							<form name="changeDelayTimeListForm"
								action="ChangeDelayTimeListAction.action" method="post">
								<input type="hidden" size="4" id="delaylids" name="delaylids" />
								...
								<table width="100%">
									...
									<tr>
										...
										<td><input type="text" size="4" id="delayTimeListNew"
											name="delayTimeNew" value="600" onchange="ischeckListNum()" />
											sec</td>
									</tr>
									<tr>
										<td align="center" colspan="2"><a class="button"
											onclick="changeDelayTimeListForm.submit()"><span
												class="buttonRight">提交</span> </a> <a class="button"
											href="javascript:visclose('submitDelayTimeListChange')"><span
