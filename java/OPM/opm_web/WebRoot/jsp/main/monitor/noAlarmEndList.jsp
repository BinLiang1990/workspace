...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitnoAlarmEndTimeListChange" class="floatdiv_content"
		style="width: 500px">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td width="13" height="33" class="td_topleft"></td>
				<td class="td_topcenter"><div class="floatdiv_top"
						onMouseDown="moveEvent(event,'submitnoAlarmEndTimeListChange')">
						<span>报警忽略调整</span>
						<!-- 弹出层标题 -->
						<a href="javascript:visclose('submitnoAlarmEndTimeListChange')">
							<img src="js/float/images/dialog_closebtn.gif"
			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						<!-- 弹出层内容开始 -->
						<div class="submitnoAlarmEndTimeListChange">
							<form name="changeNoAlarmEndTimeListForm"
								action="ChangeNoAlarmEndTimeListAction.action" method="post">
								<input type="hidden" size="4" id="naelids" name="naelids" /> <input
								...
								<table width="100%">
									...
									<tr>
										<td align="center" colspan="2"><a class="button"
											onclick="changeNoAlarmEndTimeListForm.submit()"><span
												class="buttonRight">提交</span> </a> <a class="button"
											href="javascript:visclose('submitnoAlarmEndTimeListChange')"><span
