...
<script type="text/javascript" src="js/ajax/change_alarm_level.js"></script>
<div class="floatdiv">
	<div class="floatdiv_bg"></div>
	<!--遮罩背景 -->
	<div id="submitAlarmLevelChange" class="floatdiv_content"
		style="width: 500px">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td width="13" height="33" class="td_topleft"></td>
				<td class="td_topcenter"><div class="floatdiv_top"
						onMouseDown="moveEvent(event,'submitAlarmLevelChange')">
						<span>报警级别调整</span>
						<!-- 弹出层标题 -->
						<a href="javascript:visclose('submitAlarmLevelChange')"> <img
			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						<!-- 弹出层内容开始 -->
						<div class="submitAlarmLevelChange">
							<input type="hidden" size="4" id="id_1_al" name="id_1_al" /> <input
							...
							<table width="100%">
								...
								<tr>
									<td align="center" colspan="2"><a class="button"
										onclick="changeAlarmLevel()"><span class="buttonRight">提交</span>
									</a> <a class="button"
										href="javascript:visclose('submitAlarmLevelChange')"><span
