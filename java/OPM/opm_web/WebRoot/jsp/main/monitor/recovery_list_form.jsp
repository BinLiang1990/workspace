...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitRecoveryList" class="floatdiv_content"
		style="width: 500px">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				...
				<td class="td_topcenter"><div class="floatdiv_top"
						...
						<span>删除</span>
						<!-- 弹出层标题 -->
						<a href="javascript:visclose('submitRecoveryList')"> <img
							...
							<table width="100%">
								...
								<tr>
									...
									<td align="center" colspan="2"><a class="button"
										onclick="batchRecoveryAlarmPoint()"><span
											class="buttonRight">恢复</span> </a> <a class="button"
										href="javascript:visclose('submitRecoveryList')"><span
