...
<div class="menu">
	...
	<div class="menuCenter">
		<div class="menuCenterLeft">
			<ul>
				<li><a href="./GetAllAlarmPointAction.action">报警管理</a>
				</li>
				<li class="menuLine"></li>
				<li class="hover"><a href="./GetAllAlarmPointBackupAction.action">报警管理备用</a></li>
				<li class="menuLine"></li>
				<li><a href="./GetSearchAction.action">报警搜索</a></li>
				<li class="menuLine"></li>
