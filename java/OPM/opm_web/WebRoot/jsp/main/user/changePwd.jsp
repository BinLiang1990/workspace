...
<div class="floatdiv">
	...
	<!--遮罩背景 -->
	<div id="submitPwdChange" class="floatdiv_content" style="width: 500px">
			...
			<tr>
				...
				<td class="td_centercenter"><div class="floatdiv_body">
						...
						<div class="submitPwdChange">
							<form name="changePwdForm" action="ChangePwdAction.action"
								method="post">
								<input type="hidden" size="4" id="uid" name="uid"
									value="<sec:authentication property='name'/>" />
								<table width="100%">
									<tr>
										<td width="20%" align="right">新密码：</td>
										<td width="80%"><input type="text" id="pwd" name="pwd"
											size="4" /></td>
									</tr>
									<tr>
										<td align="right">确认新密码：</td>
										<td><input type="text" size="4" id="pwdag" name="pwdag" /></td>
									</tr>
									<tr>
										<td align="center" colspan="2"><a class="button"
											onclick="changePwdForm.submit()"><span
